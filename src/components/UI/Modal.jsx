                    ...
                    <div className="mt-5 flex items-center gap-3 flex-wrap">
                        ...
                        </h4>
                        {
                            portfolio.technologies.map((tech,index)=>(
                                <span key={index} className='bg-gray-200 py-1 px-2 rounded-[15px] text-[14px] leading-0'>{tech}</span>
                            ))
                        }
                    </div>
                    <a href={portfolio.siteUrl}>
                        <button className="bg-primaryColor py-2 px-4 text-white my-8 rounded-[8px] font-[500]
                            hover:bg-headingColor ease-in duration-300">Look At</button>
                    </a>
                </div>
