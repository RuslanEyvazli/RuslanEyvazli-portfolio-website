        ...
        <section id="services">
            <div className="container lg:pt-5">
                <div className="text-center">
                    ...
                    <p className="lg:max-w-[600px] lg:mx-auto text-headingColor font-[500] text-[16px] leading-7">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad perspiciatis tempora, laborum vel ratione eligendi voluptate officiis error accusamus adipisci pariatur, distinctio alias sed maxime dolor eaque praesentium iure. Unde!</p>
                </div>
                ...
                <div className="flex flex-col justify-center sm:py-12">
                    <div className="w-full py-3 px-2 sm:max-w-xl sm:mx-auto sm:px-0">
                        <div className="relative text-gray-700 antialiased text-sm font-semibold">
                                ...
                                {/* ================ left card ================== */}
                                <div className="mt-6 sm:ml-0 sm:mb-12">
                                        ...
                                        <div className="flex justify-start w-full mx-auto items-center">
                                            <div className="w-full sm:w-1/2 sm:pr-8">
                                                <div data-aos="fade-right" data-aos-duration="1200" className="bg-white p-4 rounded shadow group hover:bg-primaryColor cursor-pointer ease-in duration-150">
                                                    ...
                                                    <p className='text-[15px] text-smallerTextColor group-hover:text-white group-hover: font-[500] leading-7'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore accusantium nulla unde, dolorem repellat labore enim velit similique 
                                                        qui! Numquam magnam rerum ducimus cumque repellendus repudiandae minus modi iste qui!</p>
                                                </div>
                                            </div>
                                        </div>
